...
from arachneserver.tests.BaseFlaskApp import BaseFlaskApp
from arachneserver.exceptions import EndpointException
from arachneserver.flaskapp import endpoint_evaluator
...
class TestFlaskEndpoints(BaseFlaskApp):
    ...
    @patch('arachneserver.default_endpoints.start_crawler')
    ...
    def test_custom_endpoints(self):
        ...
        from arachneserver.tests.custom_endpoints import endpoint_invalid_method
    ...
    def test_custom_endpoint_no_url(self):
        ...
        from arachneserver.tests.custom_endpoints import endpoint_no_url
        with self.assertRaises(EndpointException) as context:
    ...
    def test_custom_endpoint_invalid_url(self):
        ...
        from arachneserver.tests.custom_endpoints import endpoint_invalid_url
        with self.assertRaises(EndpointException) as context:
    ...
    def test_custom_endpoint_default_method(self):
        ...
        from arachneserver.tests.custom_endpoints import endpoint_no_methods_supplied
